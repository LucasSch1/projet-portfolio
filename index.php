    ...
    <div class="container-fluid pt-5 h-75 d-flex align-items-center justify-content-center">
        <div class="row d-flex align-items-center justify-content-center w-75 h-75" id="conteneur-profil">
            ...
            <div class="col-md-6 text-black text-center fs-2 align-bottom">
                ...
                <p class="fs-5">Jeune développeur de 19 ans, actuellement en BTS SIO deuxième année, je suis passionné par le développement web et souhaiterais en faire mon futur métier . J'ai déjà des compétences/savoir dans certains langages (pour en savoir plus, allez voir mon CV &#128521;)</p>
            </div>
            <div class="col-md-1">
            </div>
        </div>
